...
const DisplayAddedOrders = ({
  ...
  const handleInputChange = (index, field, value) => {
    const updatedOrders = Object.entries(orders).map(
    ...
    setOrders(
      Object.fromEntries(
        updatedOrders.map((product, i) => [Object.keys(orders)[i], product])
      )
    );
  };
    ...
    <div>
      ...
      <div className="d-grid gap-2 d-md-flex justify-content-md-start">
        <Button
          ...
          onClick={() => handleRemoveOrder(sheetName)}
        >
          Remove
        </Button>
